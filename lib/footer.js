...
// TODO: None of these buttons exist as images?
...
d3
	...
	.property(
		"value",
		'<iframe width="940" height="710" src="' +
			document.URL +
...
d3.select("#downloadshare").on("click", function() {
	saveSvgAsPng(document.getElementById("chart"), "fallback.png");
});
